    ...
    for result in results:
        ...
        for box in boxes:
            ...
            if cls in [0, 1, 2 , 3 , 4 , 7 , 12 , 14 , 15 , 16] and conf > 0.5:
                ...
                if cls == 0:
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)   # Green color for cars
                    cv2.putText(frame, '10 wheeler', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                elif cls == 1:
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)  # Red color for motorcycles
                    cv2.putText(frame, 'MotorVan', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
                elif cls == 2:
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)   # Blue color for trucks
                    cv2.putText(frame, 'MotorVan', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 1)
                elif cls == 3:
                    cv2.rectangle(frame, (x1, y1), (x2, y2),(0, 0, 255), 2)   # Green color for MotorVan
                    cv2.putText(frame, '4 Wheeler', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                elif cls == 4:
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)  # Green color for MotorVan
                    cv2.putText(frame, '6 Wheeler', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                elif cls == 7:
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)   # Green color for MotorVan
                    cv2.putText(frame, '6 Wheeler', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                elif cls == 12:
